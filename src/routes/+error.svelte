			...
			>
				<a
					...
					><svg
						...
						/></svg
					><span class="min-[431px]:text-xl text-xs text-center text-white">ดิสคอร์ดคนนอนดึก</span
					></a
				>
				<hr
					class="MuiDivider-root MuiDivider-fullWidth MuiDivider-vertical MuiDivider-flexItem bg-white"
				/>
				<div

...
<script lang="ts">
	...
	const		imgURL3 = '/img/icon/20230727152958-f08c0f94-dcc0-4366-9eec-13b1c5c5d6e7.png';
	const		bgColorCode3 = '#ffe8a8';
	const		borderColor3 = '#aeb84c';

	const		picturename4 = 'heart';
	const		desc4 = 'ความรักที่มีต่อคุณบากุ';
	const		imgURL4 = '/img/icon/20230727153149-141a60ce-e086-4f4a-b624-966315f86c46.png';
	...
	<div class="-mt-7">
		<div class="mx-auto rounded-xl py-4 sm:px-6 lg:px-8">
			...
			>
				...
				<div class="flex w-full flex-col px-4 py-2 absolute top-0 left-0 pb-11">
					<div class="flex">
						<img src={imgURL3} class="h-[80px] object-contain" alt="gift" /><b
							class="text-[#4E4670] min-[425px]:text-[20px] text-[14px] overflow-hidden pt-4 min-[425px]:pr-20 min-[375px]:pr-16 pr-14"
							>{bwish.name}</b
						>
					</div>
		...
		>
			...
			<div class="flex w-full flex-col px-4 py-2 absolute top-0 left-0 pb-11">
				<div class="flex">
					<img src={imgURL4} class="h-[80px] object-contain" alt="gift" /><b
						class="text-[#4E4670] min-[425px]:text-[20px] text-[14px] overflow-hidden pt-4 min-[425px]:pr-20 min-[375px]:pr-16 pr-14"
						>{bwish.name}</b
					>
				</div>

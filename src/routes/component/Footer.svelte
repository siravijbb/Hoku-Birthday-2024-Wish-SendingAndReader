<div
	class="w-full h-9 flex flex-row gap-2 fixed bottom-0 bg-[#FA8128] z-[1] p-2 text-white justify-center items-center"
>
	<a
		...
		><svg
			...
			data-prefix="fab"
			data-icon="discord"
			class="svg-inline--fa fa-discord text-[24px] aspect-square h-7"
			role="img"
